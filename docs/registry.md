...
| [docs/adrs/ADR-002.md](./adrs/ADR-002.md) | ADR-002: GitOps tooling — evaluation of ArgoCD and FluxCD; decision to use ArgoCD for continuous cluster state reconciliation | 1.0 | 2026-05-24 | GitOps controller changes or hardware profile changes affect the resource budget |
...
| [docs/registry.md](./registry.md) | Index of all living documents with version, coverage summary, and update triggers | 2.2 | 2026-05-24 | Any living document is created, modified, or removed |
