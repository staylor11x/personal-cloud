...
| [docs/contributing/templates/issue-template.md](./contributing/templates/issue-template.md) | Template for agent-targeted GitHub issues — required sections, phase and ADR metadata, and documentation update criterion | 1.0 | 2026-05-23 | Issue process changes or required sections are added or removed |
...
| [docs/registry.md](./registry.md) | Index of all living documents with version, coverage summary, and update triggers | 1.7 | 2026-05-23 | Any living document is created, modified, or removed |
...
| [.github/agents/application-agent.md](../.github/agents/application-agent.md) | Application agent instructions — role, absolute rules, deployment and backup standards, phase constraints, and escalation conditions | 1.0 | 2026-05-23 | Application deployment conventions change, new applications added to ADR-005, or phase scope changes |
